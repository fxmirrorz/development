...
if D.client == "itIT" then
	...
	L.popup_install = "La prima volta che esegui DuffedUI v15 con questo personaggio. Devi ricaricare la tua UI per settare le barre di azione, le variabili e la chat."
	...
	L.core_uihelp9 = "|cffFF0000/resetui|r - Reset DuffedUI alle impostazioni di default."
	...
	L.tutorial_step_1_line_3 = "Questa installazione è parzialmente specifica per il singolo personaggio. Mentre alcune impostazioni che verranno applicate in seguito saranno account-wide, devi avviare lo script di installazione per ogni nuovi personaggio che esegue DuffedUI. Lo script si esegue in automatico su ogni nuovo personaggio per la priam volta. Inoltre le opzioni si possono trovare in /DuffedUI/config/config.lua per gli utenti `Power` users oppure digitando /tukui in gioco per `Friendly` users"
	...
	L.tutorial_step_3_line_2 = "Non a tutti piaciono cose come DPS, Boss mods, Threat meters, etc, abbiamo deciso che era la cosa migliore. DuffedUI è creato attorno ad una idea che vada bene per tutte le classi, ruoli e spec. Per questo DuffedUI è uno dei più popolari UI in questo momento. Si adatta a tutti gli stili di gioco ed è estremamente editabile. E' disegnato anche per esssere un buon inizio per tutti quelli che vogliono iniziare a costruire una propia UI senza dipendere dagli addon. Dal 2009 multi utenti hanno iniziato ad usare DuffedUI come base per la loro UI. Date Un'occhiata alla sezione Edited Packages sul nostro sito!"
	...
	-- tutorial 5
	L.tutorial_step_5_line_1 = "Ultimo, DuffedUI include una lista di comandi utili. "
	...
	L.tutorial_step_6_line_2 = "Ti suggerisco di dare un'occhiata a config/config.lua o digitare /DuffedUI per personalizzare la UI come vuoi."
