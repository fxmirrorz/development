...
local function SetChatStyle(frame)
	...
	_G[chat.."EditBox"]:Point("TOPLEFT", DuffedUITabsLeftBackground or DuffedUIInfoLeft, 2, -2)
	_G[chat.."EditBox"]:Point("BOTTOMRIGHT", DuffedUITabsLeftBackground or DuffedUIInfoLeft, -2, 2)	
	...
	_G[chat.."EditBox"].backdrop:SetAllPoints(DuffedUITabsLeftBackground or DuffedUIInfoLeft)
