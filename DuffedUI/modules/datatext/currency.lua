...
if C["datatext"].currency and C["datatext"].currency > 0 then
	local Stat = CreateFrame("Frame", "DuffedUIStatCurrency")
	...
	local Text  = Stat:CreateFontString("DuffedUIStatCurrencyText", "OVERLAY")
	Text:SetFont(C["media"].font, C["datatext"].fontsize)
	D.DataTextPosition(C["datatext"].currency, Text)
