...
local Stat = CreateFrame("Frame", "DuffedUIStatSystem")
...
local Text  = Stat:CreateFontString("DuffedUIStatSystemText", "OVERLAY")
Text:SetFont(C["media"].font, C["datatext"].fontsize)
D.DataTextPosition(C["datatext"].system, Text)
