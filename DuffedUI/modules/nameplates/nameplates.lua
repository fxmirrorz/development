...
local NamePlates = CreateFrame("Frame", "DuffedUINameplates", UIParent)
...
RoleUpdater:SetScript("OnEvent", function() Role = D.CheckRole() end)
...
local function SkinObjects(frame)
	...
	cb.time:SetShadowOffset(D.mult, -D.mult)
	...
	cb.name:SetShadowOffset(D.mult, -D.mult)		
