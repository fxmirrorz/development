...
local function LoadSkin()
	...
	if IsMacClient() then
		...
		--Skin buttons
		D.SkinButton(_G["MacOptionsFrameCancel"])
		D.SkinButton(_G["MacOptionsFrameOkay"])
		D.SkinButton(_G["MacOptionsButtonKeybindings"])
		D.SkinButton(_G["MacOptionsFrameDefaults"])
		D.SkinButton(_G["MacOptionsButtonCompress"])
		...
		_G["MacOptionsButtonCompress"]:SetPoint(tPoint, tRTo, tRP, D.Scale(4), tY)
		...
		_G["MacOptionsFrameCancel"]:SetPoint(tPoint, tRTo, tRP, D.Scale(-14), tY)

		_G["MacOptionsFrameOkay"]:ClearAllPoints()
		_G["MacOptionsFrameOkay"]:SetWidth(96)
		_G["MacOptionsFrameOkay"]:SetHeight(22)
		_G["MacOptionsFrameOkay"]:SetPoint("LEFT",_G["MacOptionsFrameCancel"],D.Scale(-99),0)
		...
		_G["MacOptionsButtonKeybindings"]:SetPoint("LEFT",_G["MacOptionsFrameOkay"],D.Scale(-99),0)
